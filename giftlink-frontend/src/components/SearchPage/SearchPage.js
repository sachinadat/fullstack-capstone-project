                ...
                <div className="col-md-6">
                    <div className="filter-section mb-3 p-3 border rounded">
                        ...
                        <div className="d-flex flex-column">
                            ...
                            <select id="categorySelect" className="filter-section form-control my-1">
                            ...
                            <select id="conditionSelect" className="filter-section form-control my-1">
                                <option value="">All</option>
                            ...
                            <input
                                type="range"
                                className="age-range-slider form-control-range"
                                id="ageRange"
                                min="1"
                                max="10"
                                value={ageRange}
